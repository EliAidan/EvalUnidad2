...
class Portador(HTTPBearer):
    async def __call__(self,request:Request,db:Session = Depends(get_db)):
        ...
        db_userlogin= crud.users.get_user_by_credentials(db,username=dato["Nombre_Usuario"], correo=dato["Correo_Electronico"],telefono=dato["Numero_Telefono_Movil"],password=dato["Contrasena"])
